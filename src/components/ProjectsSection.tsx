...
const fullStackProjects: Project[] = [
  ...
  },
  {
    ...
    detail: [
      "AudioMatrix is a full-stack audio platform that lets users stream tracks, build playlists, and manage a personal library with a Spotify-inspired interface.",
      "Built with Next.js, TypeScript, and Tailwind on the frontend, with a server-rendered catalog and client-side player state for instant playback transitions.",
      "Authentication, library persistence, and metadata are powered by a managed backend, with a streaming-friendly architecture that keeps audio responsive across devices.",
      "Deployed on Vercel with a CI/CD-friendly project layout that makes shipping new features and integrations straightforward.",
    ],
    tags: ["Next.js", "TypeScript", "Tailwind", "Streaming"],
    accentColor: "primary",
    github: "https://audiomatrix-full-stack-dmxn.vercel.app/",
    demo: "https://audiomatrix-full-stack-dmxn.vercel.app/",
    demoLabel: "Live App",
    demoIcon: "web",
    stats: [
      { label: "Player", value: "Live" },
  ...
  },
  {
    ...
    detail: [
      "Full Stack E-Commerce is a complete online shopping experience with a product catalog, persistent cart, secure checkout, and account management.",
      "Built with Next.js and TypeScript, featuring server-rendered product pages, dynamic category routing, and a responsive Tailwind UI.",
      "Order flow, authentication, and inventory state are wired through a managed backend, with payment-ready integration points for Stripe-style providers.",
      "Architected with a modular component layer so new product categories, promotions, and checkout steps slot in cleanly.",
    ],
    tags: ["Next.js", "TypeScript", "Tailwind", "Checkout"],
    accentColor: "accent",
    github: "https://full-stack-ecommerce-app-sigma.vercel.app/",
    demo: "https://full-stack-ecommerce-app-sigma.vercel.app/",
    demoLabel: "Live Store",
    demoIcon: "web",
    stats: [
      { label: "Catalog", value: "SSR" },
      { label: "Cart", value: "Live" },
      { label: "Auth", value: "Yes" },
      { label: "Deploy", value: "Vercel" },
    ],
  },
  {
    ...
    detail: [
      "Math Course Platform is a learning experience for structured math courses, with a lesson-by-lesson reader, navigation across modules, and a focus on readability.",
      "Built with Next.js App Router and Tailwind CSS, optimized for fast page loads, deep-linkable lessons, and an accessible reading layout.",
      "Course content is organized into modules and chapters, with progress-friendly UX and a clean typographic system tuned for math-heavy material.",
      "Designed to be easily extended with quizzes, exercises, and richer interactive widgets in future iterations.",
    ],
    tags: ["Next.js", "Tailwind", "EdTech", "MDX"],
    accentColor: "primary",
    github: "https://nextjs-math-course.vercel.app/",
    demo: "https://nextjs-math-course.vercel.app/",
    demoLabel: "Open Course",
    demoIcon: "web",
    stats: [
      { label: "Lessons", value: "Many" },
      { label: "Reader", value: "Clean" },
      { label: "Stack", value: "Next" },
      { label: "Deploy", value: "Vercel" },
    ],
  },
  {
    ...
    detail: [
      "Himalayan Connect is a full-stack community platform built to connect the Himalayan diaspora in NYC, surfacing events, local listings, and community resources.",
      "Built with Next.js and a modern serverless backend, with role-aware experiences for members, organizers, and admins.",
      "Listings, search, and event flows are designed for mobile-first browsing, with an emphasis on accessibility and clarity.",
      "Architected to scale into multiple cities with shared content models and per-city customization.",
    ],
    tags: ["Next.js", "Community", "Serverless", "Mobile-First"],
    accentColor: "accent",
    github: "https://himalayan-connect-nyc.vercel.app/",
    demo: "https://himalayan-connect-nyc.vercel.app/",
  ...
  },
  {
    ...
    detail: [
      "Agent Portal is a full-stack internal tool that gives agents a single dashboard to manage workflows, track activity, and act on tasks in real time.",
      "Built with Next.js and TypeScript, with protected routes, role-based access, and a clean dashboard layout designed for daily operational use.",
      "Server actions handle CRUD operations against a managed backend, while a polished Tailwind UI keeps dense data scannable.",
      "Designed as a foundation for ops-heavy products that need fast iteration on internal tooling.",
    ],
    tags: ["Next.js", "TypeScript", "Auth", "Dashboard"],
    accentColor: "primary",
    github: "https://agent-portal-wn8z.vercel.app/",
    demo: "https://agent-portal-wn8z.vercel.app/",
    demoLabel: "Open Portal",
    demoIcon: "web",
    stats: [
      { label: "Auth", value: "RBAC" },
  ...
  },
  {
    ...
    detail: [
      "Snuzz Pro is a SaaS-style web application with a polished marketing surface and a fully wired-up authenticated product area.",
      "Built with Next.js, TypeScript, and Tailwind, featuring server-rendered marketing pages and a client-driven product experience.",
      "Authentication, session handling, and protected routes are integrated via a managed auth provider, with persistent state in a managed database.",
      "The component architecture is designed for fast feature iteration and brand-consistent UX across both marketing and app surfaces.",
    ],
    tags: ["Next.js", "TypeScript", "Tailwind", "SaaS"],
    accentColor: "accent",
    github: "https://snuzz-pro.vercel.app/",
    demo: "https://snuzz-pro.vercel.app/",
    demoLabel: "Visit Site",
    demoIcon: "web",
    stats: [
  ...
  },
  {
    ...
    detail: [
      "Clothes Store is a fashion-focused e-commerce frontend with category browsing, product detail pages, and a persistent cart, designed around editorial product imagery.",
      "Built with Next.js and Tailwind for a fast, responsive shopping experience with mobile-first interactions and crisp typographic detail.",
      "Cart state and product data are wired through a clean data layer, ready to plug into payments and inventory backends.",
      "Designed to feel like a boutique brand site rather than a generic storefront, with attention to spacing, typography, and motion.",
    ],
    tags: ["Next.js", "Tailwind", "E-Commerce", "Fashion"],
    accentColor: "primary",
    github: "https://clothes-nu-roan.vercel.app/",
    demo: "https://clothes-nu-roan.vercel.app/",
    demoLabel: "Visit Store",
    demoIcon: "web",
    stats: [
  ...
  },
  {
    ...
    detail: [
      "Audiophile E-Commerce is a premium audio products store with category landing pages, rich product detail views, and a multi-step checkout flow.",
      "Built with Next.js and Tailwind, with carefully tuned typography, spacing, and motion to match the high-end product positioning.",
      "Cart and order state persist across navigation, while a structured checkout collects shipping, payment, and confirmation in a polished flow.",
      "Designed as a portfolio-grade demonstration of e-commerce frontend craft from landing page to receipt.",
    ],
    tags: ["Next.js", "Tailwind", "E-Commerce", "Checkout"],
    accentColor: "accent",
    github: "https://audiophile-ecommerce-app-xi.vercel.app/",
    demo: "https://audiophile-ecommerce-app-xi.vercel.app/",
    demoLabel: "Live Store",
    demoIcon: "web",
    stats: [
      { label: "Tier", value: "Premium" },
      { label: "Checkout", value: "Multi" },
      { label: "Stack", value: "Next" },
      { label: "Deploy", value: "Vercel" },
    ],
  },
  {
    ...
    detail: [
      "Team Chat is a realtime messaging app with channels, direct conversations, and shareable invite links for onboarding new members.",
      "Built with Next.js and TypeScript, with a realtime data layer powering live message delivery, presence, and channel updates.",
      "Authentication, workspace membership, and message persistence are wired through a managed backend, while the UI focuses on chat-grade responsiveness.",
      "Architected as a foundation for collaboration tools where realtime feel and identity-aware UX matter most.",
    ],
    tags: ["Next.js", "Realtime", "TypeScript", "Auth"],
    accentColor: "primary",
    github: "https://team-chat-next.vercel.app/",
    demo: "https://team-chat-next.vercel.app/invite/03bf69e3-9bf4-4d53-991c-c3a179f14409",
    demoLabel: "Join Chat",
    demoIcon: "web",
    stats: [
      { label: "Realtime", value: "Yes" },
      { label: "Invites", value: "Link" },
      { label: "Stack", value: "Next" },
      { label: "Deploy", value: "Vercel" },
    ],
  },
  {
    ...
    detail: [
      "University Library Management is a full-stack platform for managing a university book catalog, borrowing requests, and member accounts.",
      "Built with Next.js, TypeScript, and Tailwind, featuring server-rendered catalog pages, a borrow/return workflow, and an authenticated member area.",
      "An admin surface manages books, users, and borrowing activity, with role-based access protecting administrative actions.",
      "Designed to scale from a single department to a multi-faculty library with shared catalog infrastructure.",
    ],
    tags: ["Next.js", "TypeScript", "Auth", "RBAC"],
    accentColor: "accent",
    github: "https://university-library-managment.vercel.app/",
    demo: "https://university-library-managment.vercel.app/",
    demoLabel: "Open Library",
    demoIcon: "web",
    stats: [
      { label: "Catalog", value: "Full" },
      { label: "Borrow", value: "Flow" },
      { label: "Auth", value: "RBAC" },
      { label: "Deploy", value: "Vercel" },
    ],
  },
  {
    ...
    detail: [
      "TaleCrafter AI is a full-stack storytelling platform that helps users generate, refine, and share AI-assisted tales with rich visuals.",
      "Built with Next.js and TypeScript, with a polished marketing site and an authenticated creator workspace for drafting and managing stories.",
      "AI generation is powered by hosted LLM and image models, with a stateful editor that keeps story arcs, characters, and scenes in sync.",
      "Deployed at a custom domain, with a production-grade architecture spanning auth, data, and AI orchestration.",
    ],
    tags: ["Next.js", "TypeScript", "AI", "LLM"],
    accentColor: "primary",
    github: "https://www.talecrafterai.tech/",
    demo: "https://www.talecrafterai.tech/",
    demoLabel: "Visit Site",
    demoIcon: "web",
    stats: [
      { label: "AI", value: "LLM" },
      { label: "Editor", value: "Live" },
